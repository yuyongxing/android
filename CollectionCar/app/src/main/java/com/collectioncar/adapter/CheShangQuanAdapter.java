...
import com.collectioncar.util.DpPxUtil;
import com.collectioncar.view.MyGridView;
    ...
    public class GirdViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
         ...
         /*   Glide.with(CheShangQuanAdapter.this.mContext).load(piclist.get(position))
            ...
            Glide.with(CheShangQuanAdapter.this.mContext).load(piclist.get(position)).asBitmap()
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
